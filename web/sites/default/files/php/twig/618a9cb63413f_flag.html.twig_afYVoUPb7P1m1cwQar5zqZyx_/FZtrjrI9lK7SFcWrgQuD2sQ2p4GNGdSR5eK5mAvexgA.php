...
class __TwigTemplate_41de6a72c6c5d26eba39593fe223cd74e8407ee87031de0f7302e902b3a04280 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((($context["action"] ?? null) == "unflag")) {
            // line 23
            echo "    ";
            $context["action_class"] = "action-unflag fa fa-heart-o";
        } else {
            // line 25
            echo "    ";
            $context["action_class"] = "action-flag fa fa-heart";
        }
        // line 27
        echo "
";
...
{% if action == 'unflag' %}
    {% set action_class = 'action-unflag fa fa-heart-o' %}
{% else %}
    {% set action_class = 'action-flag fa fa-heart' %}
{% endif %}
